...
<div class="container">
      ...
      <form class="form-signin" >
        ...
        <button id="encerraProcessoSeletivo" type="button" class="btn btn-lg btn-primary btn-block" >Encerrar Processo Seletivo</button><br>
		<button id="continuarElaboracaoProva" type="button" class="btn btn-lg btn-primary btn-block" >Criar Outra Prova</button><br>
		<button id="sairPaginaAdministrador" type="button" class="btn btn-md btn-primary btn-block" >Sair</button>    
      </form>
